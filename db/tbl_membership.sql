...
--
-- Host: localhost
-- Generation Time: Feb 05, 2016 at 03:45 AM
...
INSERT INTO `tbl_membership` (`ms_id`, `ms_type`, `ms_validity_period`, `ms_price`, `ms_book_limit`, `ms_days_limit`) VALUES
(1, 'Platinum', 5, 1000, 10, 10),
(2, 'Gold', 3, 500, 5, 5),
(3, 'Silver', 3, 300, 3, 3);
